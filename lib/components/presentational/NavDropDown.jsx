...
import { Box, Divider, Flex, Link as RenditionLink, Txt } from 'rendition';

import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faChevronDown } from '@fortawesome/free-solid-svg-icons/faChevronDown';
import { faChevronUp } from '@fortawesome/free-solid-svg-icons/faChevronUp';

const windowGlobal = typeof window !== 'undefined' && typeof document !== 'undefined' && window;
				...
				<PanelWrapper>
					<Panel px={2} py={2}>
						{React.Children.map(props.children, (child, index) => {
							return (
								<Box key={index}>
									{props.showDividers && index !== 0 && <Divider my={0} mx={3} color="text.main" />}
